...
class Square:
    ...
    def __eq__(self, other):
        """Check if the area of the instance is the same as
        the area of 'other'.
        Returns:
            bool: The return Value. True if self.area == other.area.
            False otherwise, or 'other' is not of type Square.
        """
        return isinstance(other, Square) and self.area() == other.area()

    def __ne__(self, other):
        """Check if the area of the instance is not the same as the area
        of 'other'.
        Returns:
            bool: The return Value. True if self.area != other.area.
            False otherwise, or 'other' is not of type Square.
    ...
    def __ge__(self, other):
        """Check if the area of the instance is greater than or
